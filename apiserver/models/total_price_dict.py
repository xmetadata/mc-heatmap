...
class TotalPriceModel(db.Model, CRUD):
    ...
    price_start = db.Column(db.Integer, comment = '总价结束数')
    price_type  = db.Column(db.Integer, comment = '总价类型, 0: 内置， 1: 自定义')

    def __init__(self, price_start, price_end, price_type_):
