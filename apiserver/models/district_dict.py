...
class DistrictModel(db.Model, CRUD):
    ...
    district_uuid = db.Column(db.String(36), default = get_uuid, primary_key = True, comment = u'区域索引')
    ...
    city_uuid = db.Column(db.String(36), db.ForeignKey('t_city_dict.city_uuid'), comment = u'外键，区域所属市索引')
